...
rect = patches.Rectangle((100, -1), 25, 2, color = 'pink')
rect2 = patches.Rectangle((125, -1), 25, 2, color = 'orange')


ax.add_patch(rect)
ax.add_patch(rect2)
ax.text(100, .8, r'$\varepsilon_r = 9$', size = 'x-large')
ax.text(125, .8, r'$\varepsilon_r = 3$', size = 'x-large')
plt.title('One-Dimensional Wave with Two Dielectric Layers')
plt.xlabel('Space')
